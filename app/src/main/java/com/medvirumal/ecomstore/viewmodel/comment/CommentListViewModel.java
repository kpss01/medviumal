...
import com.medvirumal.ecomstore.repository.comment.CommentRepository;
...
public class CommentListViewModel extends PSViewModel {
    ...
    private MutableLiveData<com.medvirumal.ecomstore.viewmodel.comment.CommentListViewModel.TmpDataHolder> sendCommentHeaderPostDataObj = new MutableLiveData<>();
    ...
    public void setSendCommentHeaderPostDataObj(String product_id,
        ...
        if (!isLoading) {
            com.medvirumal.ecomstore.viewmodel.comment.CommentListViewModel.TmpDataHolder tmpDataHolder = new com.medvirumal.ecomstore.viewmodel.comment.CommentListViewModel.TmpDataHolder();
