    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        try {
            if  (requestCode == RESULT_LOAD_IMAGE && resultCode == RESULT_OK && null != data) {
                ...
                Toast.makeText(UploadActivity.this,encImage,Toast.LENGTH_LONG).show();
           ...
           else if (requestCode == CAMERA_REQUEST && resultCode == Activity.RESULT_OK)
            {
                ...
                imgPres.setVisibility(View.VISIBLE);
                imgPres.setImageBitmap(photo);

                Uri tempUri = getImageUri(getApplicationContext(), photo);

                // CALL THIS METHOD TO GET THE ACTUAL PATH
                File finalFile = new File(getRealPathFromURI(tempUri));
                encImage = getRealPathFromURI(tempUri);
           ...
           /* else  if (requestCode == CAMERA_REQUEST && resultCode == Activity.RESULT_OK)
            {
                ...
                Toast.makeText(UploadActivity.this,selectedImage.toString(),Toast.LENGTH_LONG).show();
                ...
                Toast.makeText(UploadActivity.this,selectedImage1.toString(),Toast.LENGTH_LONG).show();
