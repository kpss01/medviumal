package com.medvirumal.ecomstore.ui.category;
...
import com.medvirumal.ecomstore.databinding.FragmentCategoryListBinding;
import com.medvirumal.ecomstore.ui.category.adapter.CategoryAdapter;
...
public class TrendingCategoryFragment extends PSFragment implements DataBoundListAdapter.DiffUtilDispatchedInterface {
    ...
    protected void initUIAndActions() {
        ...
        binding.get().swipeRefresh.setOnRefreshListener(() -> {
            ...
            // update live data
            homeTrendingCategoryListViewModel.setHomeTrendingCatrgoryListDataObj(homeTrendingCategoryListViewModel.categoryParameterHolder,
                    String.valueOf(Config.LIST_CATEGORY_COUNT),
                    String.valueOf(homeTrendingCategoryListViewModel.offset));
