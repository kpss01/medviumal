package com.medvirumal.ecomstore.ui.comment.list;
...
import com.medvirumal.ecomstore.databinding.FragmentCommentListBinding;
import com.medvirumal.ecomstore.ui.comment.list.adapter.CommentListAdapter;
...
public class CommentListFragment extends PSFragment implements DataBoundListAdapter.DiffUtilDispatchedInterface {
    ...
    private void loadData() {
        ...
        LiveData<Resource<List<com.medvirumal.ecomstore.viewobject.Comment>>> news = commentListViewModel.getCommentListData();
    ...
    private void replaceData(List<com.medvirumal.ecomstore.viewobject.Comment> commentList) {
