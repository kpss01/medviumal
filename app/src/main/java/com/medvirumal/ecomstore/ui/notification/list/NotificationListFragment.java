...
import com.medvirumal.ecomstore.databinding.FragmentNotificationListBinding;
import com.medvirumal.ecomstore.ui.common.DataBoundListAdapter;
import com.medvirumal.ecomstore.ui.common.PSFragment;
import com.medvirumal.ecomstore.ui.notification.list.adapter.NotificationListAdapter;
...
public class NotificationListFragment extends PSFragment implements DataBoundListAdapter.DiffUtilDispatchedInterface {
    ...
    private void replaceData(List<com.medvirumal.ecomstore.viewobject.Noti> notificationList) {
